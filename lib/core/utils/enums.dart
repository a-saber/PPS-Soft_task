/// Centralized enums for the whole app.
/// Keeping them in `core` (instead of inside the feature) lets any feature
/// (dashboard, tickets, future features) depend on them without creating
