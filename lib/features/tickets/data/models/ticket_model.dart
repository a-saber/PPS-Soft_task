...
/// Data-layer model. Mirrors the `tickets` table exactly.
/// If the presentation layer ever needs a different shape, introduce a
/// separate domain entity — but for an app this size, one model is enough
/// and keeps things simple without violating separation of concerns
/// (the model still only knows how to (de)serialize itself).
class TicketModel extends Equatable {
  ...
  List<Object?> get props =>
      [id, ticketNumber, subject, description, priority, category, status, createdAt, updatedAt];
}
