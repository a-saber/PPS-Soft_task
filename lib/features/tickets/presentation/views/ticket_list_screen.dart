...
class _TicketListScreenState extends State<TicketListScreen> {
  ...
  Future<void> _export() async {
    ...
    try {
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(context.tr('export_failed'))),
      );
    }
  }
            ...
            children: [
              Padding(
                ...
                child: TicketFilterBar(
                  ...
                  onSearchChanged: (q) => context.read<TicketListCubit>().search(q),
                  onStatusChanged: (s) => context.read<TicketListCubit>().filterByStatus(s),
                  onSortChanged: (o) => context.read<TicketListCubit>().changeSortOrder(o),
                ),
              ),
              Expanded(
                child: tickets.isEmpty
                    ...
                    : RefreshIndicator(
                        onRefresh: () => context.read<TicketListCubit>().loadTickets(),
