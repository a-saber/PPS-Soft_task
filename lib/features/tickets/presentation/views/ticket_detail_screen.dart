  ...
  Widget build(BuildContext context) {
    return BlocProvider<TicketDetailCubit>(
      create: (_) => TicketDetailCubit(
        ticketRepository: Injector.instance.ticketRepository,
        ...
        return Scaffold(
          ...
          body: ListView(
            ...
            children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomDropdown<TicketPriority>(
                        ...
                        onChanged: (p) {
                          if (p != null) {
                            context.read<TicketDetailCubit>().updateFields(priority: p);
                          }
                        },
                      ),
              ...
              Text(context.tr('change_status'), style: const TextStyle(fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
              Wrap(
                spacing: 8,
                children: TicketStatus.values.map((s) {
                  ...
                  return ChoiceChip(
                    ...
                    onSelected: isBusy
                        ? null
                        : (_) => context.read<TicketDetailCubit>().changeStatus(s),
                  );
                }).toList(),
              ),
              ...
              Text(context.tr('history'), style: const TextStyle(fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
