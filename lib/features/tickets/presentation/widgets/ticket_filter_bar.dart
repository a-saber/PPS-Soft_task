          ...
          children: [
            Expanded(
              child: DropdownButtonFormField<TicketStatus?>(
                value: statusFilter,
                decoration: InputDecoration(labelText: context.tr('filter_by_status')),
                items: [
                  DropdownMenuItem(value: null, child: Text(context.tr('all'))),
                  ...TicketStatus.values.map(
                    (s) => DropdownMenuItem(value: s, child: Text(s.label(isArabic))),
                  ),
                ],
            ...
            Expanded(
              child: DropdownButtonFormField<SortOrder>(
                value: sortOrder,
                decoration: InputDecoration(labelText: context.tr('sort_by_date')),
                items: [
                  DropdownMenuItem(
                ...
                onChanged: (value) => onSortChanged(value ?? SortOrder.newestFirst),
              ),
            ),
          ],
        ),
