...
class TicketListState extends Equatable {
  ...
  List<TicketModel> get visibleTickets {
    var result = allTickets.where((t) {
      final matchesSearch =
          searchQuery.isEmpty || t.subject.toLowerCase().contains(searchQuery.toLowerCase());
      final matchesStatus = statusFilter == null || t.status == statusFilter;
      return matchesSearch && matchesStatus;
    }).toList();

    result.sort((a, b) => sortOrder == SortOrder.newestFirst
  ...
  List<Object?> get props =>
      [status, allTickets, searchQuery, statusFilter, sortOrder, errorMessage];
}
